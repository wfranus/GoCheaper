...
Navigation.startSingleScreenApp({
  screen: {
    screen: 'GoCheaper.ScannerScreen', // unique ID registered with Navigation.registerScreen
    title: 'GoCheaper', // title of the screen as appears in the nav bar (optional)
